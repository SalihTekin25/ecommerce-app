...
export interface RiddleStyleProps {
  ...
  hintView: StyleProp<ViewStyle> | undefined;
  hintClaim: StyleProp<TextStyle> | undefined;
  hintClaimView: StyleProp<ViewStyle> | undefined;
  ifSolvedAnswer: StyleProp<TextStyle> | undefined;
}
